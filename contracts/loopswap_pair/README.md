...
This is mainly used from loopswap factory contract to create new loopswap pair. It initialize all swap created parameters which can be updated later with owner key.
